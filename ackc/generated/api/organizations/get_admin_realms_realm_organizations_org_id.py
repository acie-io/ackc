...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[OrganizationRepresentation]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[OrganizationRepresentation]:
    return Response(
...
) -> Optional[OrganizationRepresentation]:
    """ Returns the organization representation
