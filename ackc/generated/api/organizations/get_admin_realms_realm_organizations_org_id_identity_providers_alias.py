...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[Union[Any, IdentityProviderRepresentation]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[Union[Any, IdentityProviderRepresentation]]:
    return Response(
...
) -> Optional[Union[Any, IdentityProviderRepresentation]]:
    """ Returns the identity provider associated with the organization that has the specified alias
