...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[Union[Any, GetAdminRealmsRealmUsersUserIdUnmanagedAttributesResponse200]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[Union[Any, GetAdminRealmsRealmUsersUserIdUnmanagedAttributesResponse200]]:
    return Response(
...
) -> Optional[Union[Any, GetAdminRealmsRealmUsersUserIdUnmanagedAttributesResponse200]]:
    """ 
    Args:
        realm (str):
        user_id (str):
