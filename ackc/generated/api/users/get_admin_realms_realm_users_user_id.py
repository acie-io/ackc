...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[Union[Any, UserRepresentation]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[Union[Any, UserRepresentation]]:
    return Response(
...
) -> Optional[Union[Any, UserRepresentation]]:
    """ Get representation of the user
