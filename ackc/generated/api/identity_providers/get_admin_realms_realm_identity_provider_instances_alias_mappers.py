...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['IdentityProviderMapperRepresentation']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['IdentityProviderMapperRepresentation']]:
    return Response(
...
) -> Optional[list['IdentityProviderMapperRepresentation']]:
    """ Get mappers for identity provider
