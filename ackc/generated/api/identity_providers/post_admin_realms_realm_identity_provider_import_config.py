...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[PostAdminRealmsRealmIdentityProviderImportConfigResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[PostAdminRealmsRealmIdentityProviderImportConfigResponse200]:
    return Response(
...
) -> Optional[PostAdminRealmsRealmIdentityProviderImportConfigResponse200]:
    """ Import identity provider from JSON body
