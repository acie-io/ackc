...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[GetAdminRealmsRealmIdentityProviderProvidersProviderIdResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[GetAdminRealmsRealmIdentityProviderProvidersProviderIdResponse200]:
    return Response(
...
) -> Optional[GetAdminRealmsRealmIdentityProviderProvidersProviderIdResponse200]:
    """ Get the identity provider factory for that provider id
