...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['GetAdminRealmsRealmAuthenticationClientAuthenticatorProvidersResponse200Item']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['GetAdminRealmsRealmAuthenticationClientAuthenticatorProvidersResponse200Item']]:
    return Response(
...
) -> Optional[list['GetAdminRealmsRealmAuthenticationClientAuthenticatorProvidersResponse200Item']]:
    """ Get client authenticator providers Returns a stream of client authenticator providers.
