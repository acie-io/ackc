...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['AuthenticationExecutionInfoRepresentation']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['AuthenticationExecutionInfoRepresentation']]:
    return Response(
...
) -> Optional[list['AuthenticationExecutionInfoRepresentation']]:
    """ Get authentication executions for a flow
