...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[GetAdminRealmsRealmAuthenticationPerClientConfigDescriptionResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[GetAdminRealmsRealmAuthenticationPerClientConfigDescriptionResponse200]:
    return Response(
...
) -> Optional[GetAdminRealmsRealmAuthenticationPerClientConfigDescriptionResponse200]:
    """ Get configuration descriptions for all clients
