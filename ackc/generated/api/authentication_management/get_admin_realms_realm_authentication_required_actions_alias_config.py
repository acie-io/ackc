...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[RequiredActionConfigRepresentation]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[RequiredActionConfigRepresentation]:
    return Response(
...
) -> Optional[RequiredActionConfigRepresentation]:
    """ Get RequiredAction configuration
