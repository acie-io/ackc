...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['GetAdminRealmsRealmAuthenticationUnregisteredRequiredActionsResponse200Item']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['GetAdminRealmsRealmAuthenticationUnregisteredRequiredActionsResponse200Item']]:
    return Response(
...
) -> Optional[list['GetAdminRealmsRealmAuthenticationUnregisteredRequiredActionsResponse200Item']]:
    """ Get unregistered required actions Returns a stream of unregistered required actions.
