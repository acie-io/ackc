...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['ScopeRepresentation']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['ScopeRepresentation']]:
    return Response(
...
) -> Optional[list['ScopeRepresentation']]:
    """ 
    Args:
        realm (str):
        client_uuid (str):
