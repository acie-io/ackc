...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[Union[Any, list['AbstractPolicyRepresentation']]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[Union[Any, list['AbstractPolicyRepresentation']]]:
    return Response(
...
) -> Optional[Union[Any, list['AbstractPolicyRepresentation']]]:
    """ 
    Args:
        realm (str):
        client_uuid (str):
