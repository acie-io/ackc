...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[GetAdminRealmsRealmAttackDetectionBruteForceUsersUserIdResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[GetAdminRealmsRealmAttackDetectionBruteForceUsersUserIdResponse200]:
    return Response(
...
) -> Optional[GetAdminRealmsRealmAttackDetectionBruteForceUsersUserIdResponse200]:
    """ Get status of a username in brute force detection
