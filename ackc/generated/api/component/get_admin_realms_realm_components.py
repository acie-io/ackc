...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[list['ComponentRepresentation']]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[list['ComponentRepresentation']]:
    return Response(
...
) -> Optional[list['ComponentRepresentation']]:
    """ 
    Args:
        realm (str):
        name (Union[Unset, str]):
