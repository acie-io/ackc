...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[ClientProfilesRepresentation]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[ClientProfilesRepresentation]:
    return Response(
...
) -> Optional[ClientProfilesRepresentation]:
    """ 
    Args:
        realm (str):
        include_global_profiles (Union[Unset, bool]):
