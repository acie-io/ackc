...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Optional[GetAdminRealmsRealmGroupsCountResponse200]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: niquests.Response) -> Response[GetAdminRealmsRealmGroupsCountResponse200]:
    return Response(
...
) -> Optional[GetAdminRealmsRealmGroupsCountResponse200]:
    """ Returns the groups counts.
