...
class Client:
    ...
    _timeout: Optional[float] = field(default=None, kw_only=True, alias="timeout")
    ...
    _client: Optional[niquests.Session] = field(default=None, init=False)
    _async_client: Optional[niquests.AsyncSession] = field(default=None, init=False)
    ...
    def __exit__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.get_niquests_client().__exit__(*args, **kwargs)
    ...
    async def __aexit__(self, *args: Any, **kwargs: Any) -> None:
        ...
        await self.get_async_niquests_client().__aexit__(*args, **kwargs)
